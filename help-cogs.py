...
class helpcogs(commands.Cog):
    ...
    async def help(self, ctx):
        await ctx.send("```\nCOMMANDS\nBot command prefix = mal.\nExample: mal.anime Attack on Titan\n\n"
                       ...
                       + "\ncoinflip = Flip a coin\n\n<Search>\nanime [title] = Search MAL for anime and display"
                       + " the info\nmanga [title] = Search MAL for manga and display the info\n\nseason [season "
                       + "(default is current)] [year (default is current)] = Shows the seasonal anime for the "
                       + "selected season.\nFormat for seasons is:\n - winter\n - spring\n - summer\n - fall\n\n"
                       + "Example: mal.season spring 2019\n\nanimerank [type (default is all)] = Displays the top "
                       + "anime in the order selected. Type means the how the anime are ranked.\nFormat for rank types"
                       ...
                       + " (default is all)] = Displays the top manga in the order selected. Type means how the manga"
                       ...
                       + "bot is still very new and I am working on adding more stuff to it which will allow you to do "
                       + "more things with MAL and your personal anime/manga lists. I'll update this command screen"
                       + " as I add them.\n```\n")
